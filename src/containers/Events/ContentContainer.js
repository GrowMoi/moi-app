  ...
  render() {
    ...
    return (
      <LinearGradient
        ...
        <View style={{ width: width - 10, minHeight: height, borderRadius: 10, borderWidth: 1, borderColor: '#E3BB83' }}>
          <LinearGradient
            colors={colorsContent}
            start={start}
            end={end}
            style={{ padding: 5, alignItems: 'center', borderRadius: 10, width: width - 10, minHeight: height, ...style }}>
            {children}
          </LinearGradient>
        </View>
      </LinearGradient>
