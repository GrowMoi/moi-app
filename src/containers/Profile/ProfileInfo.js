...
const ProfileInfo = ({ data, isShared = false, onClickEdit, tabsData, onClickSignOut, enableScroll }) => {
  ...
  return (
    <Container>
      <ScrollView contentContainerStyle={styles.scrollContainer} scrollEnabled={enableScroll}>
        <HeaderProfile>
